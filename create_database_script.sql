...
(
	...
	constraint customer_book_ibfk_1
		foreign key (customer_id) references customer (customer_id),
	constraint customer_book_ibfk_2
		foreign key (book_id) references book (book_id),
	constraint customer_book_ibfk_3
		foreign key (customer_id) references customer (customer_id),
	constraint customer_book_ibfk_4
		foreign key (book_id) references book (book_id)
)
;

create index book_id
	on customer_book (book_id)
;
...
(
	...
	constraint FK_genre_book_book
		foreign key (book_id) references book (book_id),
	constraint FK_genre_book_genre
